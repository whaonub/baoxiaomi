<template>
  <div class="dt-pages family-reports-simple-page">
            ...
            <div class="report-content">
              <div class="pc-wrapper">
                <div class="t-head-top">
                  ...
                  <div class="ht-round"></div>
                </div>
                <div class="type-content pc-content">
                  <p class="dashed"></p>
                  <p class="ht-round-little"></p>
                  <div class="head-top">{{reportData.familyName}}的家庭保障测评得分</div>
                  <div class="pc-chart">
                    <!--综合保障指数-柱状图-->
                ...
                <div class="data-group">
                  <div class="data-group-box one-item">
                    <p>
                      <icon class="dt-icon client002" name="client002"></icon>
                      <span>保障对象</span>
                    </p>
                  ...
                  <div class="data-group-box ml-30 two-item">
                    <p>
                      <icon class="dt-icon text101" name="text101"></icon>
                      <span>保单合计</span>
                    </p>
                  ...
                  <div class="data-group-box three-item">
                    <p>
                      <icon class="dt-icon money102" name="money102"></icon>
                      <span>年交保费</span>
                    </p>
                    <p>{{reportData.prem}}</p>
                  </div>
                  <div class="data-group-box ml-30 four-item">
                    <p>
                      <icon class="dt-icon money101" name="money101"></icon>
                      <span>累计保额</span>
                    </p>
              ...
              <div class="type-content family-info">
                ...
                <h3 class="title">
                  ...
                  <div v-transfer-dom>
                    <alert v-model="doubtShow" title="提示" button-text="知道了" content="测试内容">
                      <p class="alert-text">
                        <img src="../../assets/imgs/smile.png">&nbsp;此保障已拥有
                      </p>
                      <p class="alert-text">
                        <img src="../../assets/imgs/cry.png">&nbsp;此保障缺失
                      </p>
                    </alert>
                  </div>
                </h3>
                <div v-for="(item,index) in reportData.familReportList" :key="index" class="family-info-content">
                  ...
                  <div class="health">
                    <ul>
                      <li v-if="item.securityName.includes('健康')">
                        健康
                        <img src="../../assets/imgs/smile.png" class="face">
                      </li>
                      <li v-if="!item.securityName.includes('健康')">
                        健康
                        <img src="../../assets/imgs/cry.png" class="face">
                      </li>
                      <li v-if="item.securityName.includes('意外')">
                        意外
                        <img src="../../assets/imgs/smile.png" class="face">
                      </li>
                      <li v-if="!item.securityName.includes('意外')">
                      ...
                      <li v-if="item.securityName.includes('人寿')">
                        人寿
                        <img src="../../assets/imgs/smile.png" class="face">
                      </li>
                      <li v-if="!item.securityName.includes('人寿')">
                      ...
                      <li v-if="item.securityName.includes('财富')">
                        财富
                        <img src="../../assets/imgs/smile.png" class="face">
                      </li>
                      <li v-if="!item.securityName.includes('财富')">
              ...
              <div class="type-content family-info">
                <div class="jiaofeitixing">
                  ...
                  <div class="m-baofei-right fz30">年交保费:{{reportData.prem}}元</div>
                  <div @click="gotoPayRemind" class="baozhang-detail fz32">
                    查看交费详情
                    <i></i>
                  </div>
                </div>
                <p class="text-info">提示：以上报告所载内容均为本平台对上述产品的理解，便于您了解学习保险条款所用，我们不承担给付保险金的责任，具体保险责任、责任免除、合同解除及其他内容以保险公司实际合同为准。</p>
              </div>
              <div @click="downloadWordBtn" class="download-word">
                <div class="info">
                  <div class="info-title">
                    <i></i>
                    <span>{{downloadText}}</span>
                  </div>
                  <div v-if="wordTotalSize || wordTotalSize" class="info-size">{{wordDownloadSize}}M/{{wordTotalSize}}M</div>
                </div>
                <div class="icon">
    ...
    <div v-if="guide && guide.reportSimple != 1" class="report-mask">
      <img @click="closeMask" src="../../assets/imgs/report-mask.png" alt="">
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async initData() {
      ...
      let res = await api.shortReportList({
          ...
          data: [
            {
              value: "1月",
              textStyle: {
                color: this.nowMonth == 1 ? "#feaf25" : ""
              }
            },
            {
              value: "2月",
              textStyle: {
                color: this.nowMonth == 2 ? "#feaf25" : ""
              }
            },
            {
              value: "3月",
              textStyle: {
                color: this.nowMonth == 3 ? "#feaf25" : ""
              }
            },
            {
              value: "4月",
              textStyle: {
                color: this.nowMonth == 4 ? "#feaf25" : ""
              }
            },
            {
              value: "5月",
              textStyle: {
                color: this.nowMonth == 5 ? "#feaf25" : ""
              }
            },
            {
              value: "6月",
              textStyle: {
                color: this.nowMonth == 6 ? "#feaf25" : ""
              }
            },
            {
              value: "7月",
              textStyle: {
                color: this.nowMonth == 7 ? "#feaf25" : ""
              }
            },
            {
              value: "8月",
              textStyle: {
                color: this.nowMonth == 8 ? "#feaf25" : ""
              }
            },
            {
              value: "9月",
              textStyle: {
                color: this.nowMonth == 9 ? "#feaf25" : ""
              }
            },
            {
              value: "10月",
              textStyle: {
                color: this.nowMonth == 10 ? "#feaf25" : ""
              }
            },
            {
              value: "11月",
              textStyle: {
                color: this.nowMonth == 11 ? "#feaf25" : ""
              }
            },
            {
              value: "12月",
              textStyle: {
                color: this.nowMonth == 12 ? "#feaf25" : ""
              }
            }
          ]
        },
            ...
            data: [
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 1 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 2 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 3 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 4 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 5 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 6 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 7 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 8 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 9 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 10 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 11 ? "#feaf25" : "#326bfd"
                  }
                }
              },
              {
                ...
                itemStyle: {
                  normal: {
                    color: this.nowMonth == 12 ? "#feaf25" : "#326bfd"
                  }
                }
              }
            ],
    ...
    gotoPayRemind() {
      this.$router.push({
        ...
        query: {
          ...
          name: this.reportData.familyName
        }
      });
    },
    // 拨打代理人电话
    ...
    // 返回
    goBack() {
      if (this.$route.query.from == "policyDetails") {
        this.$router.push({
    ...
    // 关闭引导提示遮罩
    closeMask() {
      this.$store.state.guide.reportSimple = 1;
      this.guide.reportSimple = 1;
      this.$userGuide({
        reportSimple: 1
      });
    }
