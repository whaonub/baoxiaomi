<template>
  <div class="calendar-content">
    <x-input
      ...
      :max="4"
      :show-clear="false"
      @on-blur="conversionValue(index,0,item,...arguments)"
    ></x-input>年
    <x-input
      class="sr_ipt"
      type="tel"
      ...
      :max="2"
      :show-clear="false"
      @on-blur="conversionValue(index,1,item,...arguments)"
    ></x-input>月
    <x-input
      class="sr_ipt"
      type="tel"
      ...
      :max="2"
      :show-clear="false"
      @on-blur="conversionValue(index,2,item,...arguments)"
    ></x-input>日
    <datetime
      ...
      month-row="{value}月"
      day-row="{value}日"
      @on-change="validateInput(index,item,...arguments)"
      :title="item.name"
    >
...
export default {
  ...
  methods: {
    ...
    validateInput(index, item, value) {
      let calendarObj = {
        index: index,
        item: item,
        value: value
    ...
    conversionValue(index, value, item, data) {
